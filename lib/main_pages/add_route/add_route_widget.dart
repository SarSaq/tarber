...
class AddRouteWidget extends StatefulWidget {
  const AddRouteWidget({super.key});

  static String routeName = 'Add_route';
  static String routePath = '/addRoute';
  ...
  Widget build(BuildContext context) {
    return FutureBuilder<List<CitiesRow>>(
      ...
      builder: (context, snapshot) {
        ...
        List<CitiesRow> addRouteCitiesRowList = snapshot.data!;
                      ...
                      Expanded(
                        child: Padding(
                          ...
                          child: FlutterFlowDropDown<String>(
                            ...
                            options: addRouteCitiesRowList
                                .map((e) => e.city)
                                .withoutNulls
                                .toList(),
                            onChanged: (val) =>
                                safeSetState(() => _model.fromValue = val),
                      ...
                      Expanded(
                        child: Padding(
                          padding: EdgeInsetsDirectional.fromSTEB(
                              0.0, 8.0, 0.0, 12.0),
                          child: FlutterFlowDropDown<String>(
                            controller: _model.toValueController ??=
                                FormFieldController<String>(null),
                            options: <String>[],
                            onChanged: (val) =>
                                safeSetState(() => _model.toValue = val),
                            width: double.infinity,
                            height: 40.0,
                            textStyle: FlutterFlowTheme.of(context)
                                .bodyMedium
                          ...
                          Expanded(
                            child: Material(
                              ...
                              child: SwitchListTile.adaptive(
                                value: _model.alcoholValue ??= false,
                                onChanged: (newValue) async {
                                  safeSetState(
                                      () => _model.alcoholValue = newValue);
                                },
                                title: Text(
                                  'Алкоголь',
                                  style: FlutterFlowTheme.of(context)
                        ...
                        children: [
                          ...
                          Expanded(
                            child: Material(
                              color: Colors.transparent,
                              child: SwitchListTile.adaptive(
                                value: _model.electronicsValue ??= false,
                                onChanged: (newValue) async {
                                  safeSetState(() =>
                                      _model.electronicsValue = newValue);
                                },
                                title: Text(
                                  'Электроника',
                                  style: FlutterFlowTheme.of(context)
                        ...
                        children: [
                          ...
                          Expanded(
                            child: Material(
                              color: Colors.transparent,
                              child: SwitchListTile.adaptive(
                                value: _model.foodsValue ??= false,
                                onChanged: (newValue) async {
                                  safeSetState(
                                      () => _model.foodsValue = newValue);
                                },
                                title: Text(
                                  'Еда',
                                  style: FlutterFlowTheme.of(context)
                          ...
                          children: [
                            ...
                            Expanded(
                              child: Material(
                                color: Colors.transparent,
                                child: SwitchListTile.adaptive(
                                  value: _model.medicineValue ??= false,
                                  onChanged: (newValue) async {
                                    safeSetState(
                                        () => _model.medicineValue = newValue);
                                  },
                                  title: Text(
                                    'Лекарства',
                                    style: FlutterFlowTheme.of(context)
                          ...
                          child: FFButtonWidget(
                            onPressed: () async {
                              await RoutesTable().insert({
                                ...
                                'foods': _model.foodsValue,
                                'alcohol': _model.alcoholValue,
                                'electronics': _model.electronicsValue,
                                'medicines': _model.medicineValue,
                                'user': currentUserUid,
                              });
