...
class RouteDetailsWidget extends StatefulWidget {
  const RouteDetailsWidget({
    super.key,
    required this.routeReceive,
  });

  final RoutesRow? routeReceive;
...
class _RouteDetailsWidgetState extends State<RouteDetailsWidget> {
  ...
  void initState() {
    ...
    _model.textController ??=
        TextEditingController(text: widget.routeReceive?.description);
            ...
            Container(
              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    Text(
                      '${widget.routeReceive?.from} - ${widget.routeReceive?.to}',
                    ...
                    Padding(
                      ...
                      child: Text(
                        '${widget.routeReceive?.priceKG?.toString()} руб/кг',
                        style: FlutterFlowTheme.of(context)
                            .titleMedium
                            .override(
                              font: GoogleFonts.roboto(
