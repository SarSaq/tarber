...
import 'carrier_public_model.dart';
export 'carrier_public_model.dart';
...
class CarrierPublicWidget extends StatefulWidget {
  ...
  @override
  State<CarrierPublicWidget> createState() => _CarrierPublicWidgetState();
}

class _CarrierPublicWidgetState extends State<CarrierPublicWidget> {
  late CarrierPublicModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CarrierPublicModel());
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      ...
      FFAppState().userFavoriteCarrierIds = _model.carrierFavorites!
          .map((e) => e.carrierId)
          .withoutNulls
          .toList()
          .toList()
  ...
  Widget build(BuildContext context) {
    ...
    return FutureBuilder<List<UsersRow>>(
      ...
      builder: (context, snapshot) {
        ...
        List<UsersRow> carrierPublicUsersRowList = snapshot.data!;

        final carrierPublicUsersRow = carrierPublicUsersRowList.isNotEmpty
            ? carrierPublicUsersRowList.first
            : null;
                                                                ...
                                                                Container(
                                                                  ...
                                                                  alignment:
                                                                      AlignmentDirectional(
                                                                          ...
                                                                          0.0),
                                                                  child: Text(
                                                                    'от ${listViewRoutesRow.priceKG?.toString()} руб',
                                                                    textAlign:
                                                                        TextAlign
                                                                            .start,
                                                                    maxLines: 1,
